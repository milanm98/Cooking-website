...
function Content(){
    return(
        <main>
            <div className="text-2xl my-5 text-center md:text-5xl text-black bg-white font-black">
                Najnovije : 
            </div>

            <div className="flex flex-col items-center content-center justify-center w-full h-auto">
                <div className="flex flex-col md:flex-row">
                    ...
                    <p className=" text-center text-1xl md:text-5xl">
                        <strong><em>Rapsberry cake</em></strong><br></br><br></br>
                        Sastojci :<br></br>
                        1l jogurta<br></br>
